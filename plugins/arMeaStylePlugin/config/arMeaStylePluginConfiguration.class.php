...
class arMeaStylePluginConfiguration extends sfPluginConfiguration
{
  public static
    $summary = 'Theme plugin based on arDominionPlugin and adjusted to MEA needs.',
    $version = '0.0.1';
  ...
  public function contextLoadFactories(sfEvent $event)
  {
    ...
    if ($context->getConfiguration()->isDebug())
    {
      ...
      $context->response->addStylesheet('/plugins/arMeaStylePlugin/css/main.less', 'last', array('rel' => 'stylesheet/less', 'type' => 'text/css', 'media' => 'all'));
    }
    else
    {
      $context->response->addStylesheet('/plugins/arMeaStylePlugin/css/min.css', 'last', array('media' => 'all'));
    }
  }
