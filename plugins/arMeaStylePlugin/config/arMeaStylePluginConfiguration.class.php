...
class arMeaStylePluginConfiguration extends sfPluginConfiguration
{
  ...
  public function contextLoadFactories(sfEvent $event)
  {
    ...
    if ($context->getConfiguration()->isDebug())
    {
      ...
      $context->response->addStylesheet('/plugins/arMeaStylePlugin/css/main.less', 'last', array('rel' => 'stylesheet/less', 'type' => 'text/css'));
    }
    else
    {
      $context->response->addStylesheet('/plugins/arMeaStylePlugin/css/min.css', 'last', array('media' => 'screen'));
    }
  }
