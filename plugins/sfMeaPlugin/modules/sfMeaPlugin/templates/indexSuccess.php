...
<section id="identityArea">
  ...
  <?php echo render_show(__('Reference code/ Signatur B'), render_value($isad->referenceCode)) ?>
...
<!-- This php if was added by Bernhard 25.06.2014. Display of individual elements can be fine-tuned in the below fashion.
 *** The user groups can be added in the Menu: Admin -> Groups when logged in as an admin. -->
...
<section id="notesArea">
  ...
  <!-- This type of php if was added by Bernhard 25.06.2014. Display of individual elements can be fine-tuned in the below fashion.
 *** The user groups can be added in the Menu: Admin -> Groups when logged in as an admin. -->
<?php if ($sf_user->hasCredential(array('administrator', 'editor'), false)): ?>
...
<!-- //Bernhard 11.06.2014 Testweise -->
<?php echo render_show(__('Signatur B'), render_value($isad[signatur_b])) ?>
<!-- <?php echo render_show(__('Signatur B'), render_value($isad->signatur_b)) ?> -->
<!-- /Bernhard 11.06.2014 -->
